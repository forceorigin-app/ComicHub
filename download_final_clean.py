"""
ONE PIECE 下载器 - 最终版（使用 fetcher_selenium_clean）
确保完全直连，不使用代理
"""
import asyncio
import logging
...
from fetcher_selenium_clean import ManhuaGuiFetcherSelenium
...
STATE_FILE = "/Users/force/.openclaw/workspace/memory/download_state_final.json"
LOG_FILE = "/tmp/download_final_clean.log"
...
async def main():
    """主函数"""
    downloader = FinalCleanDownloader()
